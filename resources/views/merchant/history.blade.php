...
@section('content')
    ...
    <div class="d-flex container flex mx-5 mt-2 mb-4">
        ...
        <a type="button" class="me-3 active btn btn-light" href="{{ route('merchant.history') }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 2 30 24" fill="none"
        ...
        <div class="flex-grow-1">
            <div class="card">
                <div class="card-header">
                    <h3>List History Pemesanan</h3>
                </div>
                <div class="card-body">
                    @if (count($transaction) == 0)
                        <div class="text-center">
                            <h4 class="text-secondary opacity-75">Belum ada pemesanan!</h4>
